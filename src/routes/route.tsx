  ...
  createRoutesFromElements(
    <Route>
      <Route path="/" element={<RootLayout />}>
        ...
        <Route path="special-features" element={<SpecialFeaturesPage title="特集" />} />

        {/* 以下、認証が必要な画面 */}
        <Route element={<ProtectedRoute />}>
          <Route path="favorites" element={<FavoritesPage title="お気に入り" />} />
          <Route path="bookmarks" element={<BookmarksPage title="ブックマーク" />} />
          <Route path="my-reviews" element={<MyReviewsPage title="マイレビュー" />} />
